 ...
 * This file demonstrates how to integrate Noderift with a web frontend
 */

// For React/Vue/Angular applications
export class NoderiftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NoderiftClient(provider, contractAddress);
